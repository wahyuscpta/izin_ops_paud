...
class PermohonanPolicy
{
    ...
    {
        return $user->can('verifikasi_permohonan');
    }

    public function validasi(User $user, Permohonan $permohonan): bool
    {
        return $user->can('validasi_permohonan');
    }
     
    public function proses_izin(User $user, Permohonan $permohonan): bool
    {
        return $user->can('proses_izin_permohonan');
    }
